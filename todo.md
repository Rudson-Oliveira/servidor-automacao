...
## 🔗 Controle Remoto do Obsidian via Web

### Objetivo
Implementar solução completa que permite controlar o Obsidian local através do servidor web, com sincronização bidirecional de arquivos.

### Serviço de Sincronização Bidirecional
- [x] Criar agente local que roda no computador do usuário
- [x] WebSocket para comunicação em tempo real com servidor
- [x] Monitoramento de mudanças no vault local (file watcher)
- [x] Upload automático de arquivos modificados
- [x] Download automático de comandos do servidor
- [x] Autenticação segura (token único por usuário)

### API de Controle Remoto
- [x] Endpoint: Listar arquivos do vault
- [x] Endpoint: Ler conteúdo de arquivo
- [x] Endpoint: Criar novo arquivo
- [x] Endpoint: Editar arquivo existente
- [x] Endpoint: Deletar arquivo
- [x] Endpoint: Buscar em todos os arquivos
- [x] Endpoint: Obter estrutura de pastas

### Interface Web de Gerenciamento
- [ ] Página /obsidian/remote com explorador de arquivos
- [ ] Editor de markdown integrado
- [ ] Preview lado a lado (markdown → renderizado)
- [ ] Busca global no vault
- [ ] Criação de notas com templates
- [ ] Sincronização em tempo real (indicador visual)

### Testes e Validação
- [ ] Testar sincronização bidirecional
- [ ] Validar edição simultânea
